...
""" CDFS """
# Get dataframes
# cdfs = read_zf_tsv('DATA/ZFOURGE/CDFS/CDFS.tsv', skiprows=375, usecols=['Seq', 'Use', 'RAJ2000', 'DEJ2000', 'F3.6', 'e_F3.6'])
# cdfs_sfr = read_zf_tsv('DATA/ZFOURGE/CDFS/CDFS_SFR.tsv', skiprows=76, usecols=['Seq', 'LIR', 'F24', 'e_F24', 'SFR', 'lmass'])
...
# df.to_csv('DATA/ZFOURGE/CDFS/CDFS_MAIN9.csv', sep=',')

""" COSMOS """
# Get dataframes
# cosmos = read_zf_tsv('DATA/ZFOURGE/COSMOS/COSMOS.tsv', skiprows=354, usecols=['Seq', 'Use', 'RAJ2000', 'DEJ2000', 'F3.6', 'e_F3.6'])
# cosmos_sfr = read_zf_tsv('DATA/ZFOURGE/COSMOS/COSMOS_SFR.tsv', skiprows=76, usecols=['Seq', 'LIR', 'F24', 'e_F24', 'SFR', 'lmass'])
...
# df.to_csv('DATA/ZFOURGE/COSMOS/COSMOS_MAIN9.csv', sep=',')

""" UDS """
# # Get dataframes
uds = read_zf_tsv('DATA/ZFOURGE/UDS/UDS.tsv', skiprows=286, usecols=['Seq', 'Use', 'RAJ2000', 'DEJ2000', 'F3.6', 'e_F3.6'])
uds_sfr = read_zf_tsv('DATA/ZFOURGE/UDS/UDS_SFR.tsv', skiprows=76, usecols=['Seq', 'LIR', 'F24', 'e_F24',  'SFR', 'lmass'])
...
df = pd.concat(dataframes, axis=1)
df['160_good'] = [0 for i in df.index]
df.to_csv('DATA/ZFOURGE/UDS/UDS_MAIN9.csv', sep=',')