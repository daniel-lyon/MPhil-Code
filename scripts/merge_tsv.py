...
# cdfs_sfr = read_zf_tsv('DATA/ZFOURGE/CDFS/CDFS_SFR.tsv', skiprows=76, usecols=['Seq', 'LIR', 'F24', 'SFR'])
...
# df.to_csv('DATA/ZFOURGE/CDFS/CDFS_MAIN5.csv', sep=',')

""" COSMOS """
# # Get dataframes
# cosmos = read_zf_tsv('DATA/ZFOURGE/COSMOS/COSMOS.tsv', skiprows=354, usecols=['Seq', 'Use', 'RAJ2000', 'DEJ2000'])
# cosmos_sfr = read_zf_tsv('DATA/ZFOURGE/COSMOS/COSMOS_SFR.tsv', skiprows=76, usecols=['Seq', 'LIR', 'F24', 'SFR'])
...
# # Export to CSV
# df = pd.concat(dataframes, axis=1)
# df.to_csv('DATA/ZFOURGE/COSMOS/COSMOS_MAIN5.csv', sep=',')

""" UDS """
# Get dataframes
uds = read_zf_tsv('DATA/ZFOURGE/UDS/UDS.tsv', skiprows=286, usecols=['Seq', 'Use', 'RAJ2000', 'DEJ2000'])
uds_sfr = read_zf_tsv('DATA/ZFOURGE/UDS/UDS_SFR.tsv', skiprows=76, usecols=['Seq', 'LIR', 'F24', 'SFR'])
...
# Export to CSV
df = pd.concat(dataframes, axis=1)
df.to_csv('DATA/ZFOURGE/UDS/UDS_MAIN5.csv', sep=',')